...
export default function EmpleadoUser() {
  ...
  const handleStartService = async (ticketId: string) => {
    ...
    try {
      ...
      // CRITICAL: Update ticket with precise timestamp for audio detection
      await ticketService.updateTicket(ticketId, {
        status: 'being_served',
        servedBy: currentEmployee.id,
        servedAt: now, // This triggers the audio in the nodo module
        waitTime
      });
      ...
      console.log('✅ TICKET STARTED - Audio should trigger in nodo module:', {
        ticketId,
