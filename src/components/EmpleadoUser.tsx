  ...
  const handleStartService = async (ticketId: string) => {
    ...
    const allWaitingTickets = state.tickets
      ...
      .sort((a, b) => {
        ...
        const aIsPersonal = t => t.queueType === 'personal' && t.assignedToEmployee === currentEmployee.id;
        const bIsPersonal = t => t.queueType === 'personal' && t.assignedToEmployee === currentEmployee.id;
        
        if (aIsPersonal(a) && !bIsPersonal(b)) return -1;
        if (!aIsPersonal(a) && bIsPersonal(b)) return 1;
        
        // Within same queue type, sort by creation/derivation time
            ...
            {waitingTickets.length > 0 && (
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                <p className="text-yellow-800 text-sm mb-2">
                  ...
                  {waitingTickets[0].queueType === 'personal' && (
